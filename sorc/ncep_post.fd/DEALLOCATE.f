...
!     MP FIELD   
      ...
      deallocate(CFR)
      if (allocated(CFR_RAW)) deallocate(CFR_RAW)
      if (allocated(DBZ)) deallocate(DBZ)
      if (allocated(DBZR)) deallocate(DBZR)
      if (allocated(DBZI)) deallocate(DBZI)
      if (allocated(DBZC)) deallocate(DBZC)
      if (allocated(mcvg)) deallocate(mcvg)
      if (allocated(NLICE)) deallocate(NLICE)
!     Wm Lewis: added
      if (allocated(NRAIN)) deallocate(NRAIN)
      if (allocated(radius_cloud)) deallocate(radius_cloud)
      if (allocated(radius_ice)) deallocate(radius_ice)
      if (allocated(radius_snow)) deallocate(radius_snow)
!GFS FIELD
